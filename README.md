...
3.CNN_Multi_Classification_Water_Turbidity: I tried identification water turbidity  use a simple model deep learning. but I think that the model is still overfitting. 
